...
def check_dependencies():
    ...
    if missing_deps:
        missing = ", ".join(missing_deps).replace("sklearn", "scikit-learn")
...
if __name__ == "__main__":
    ...
    if not (len(sys.argv) >= 2 and (
            "--help" in sys.argv[1:] or sys.argv[1] in ("--help-commands", "--version", "egg_info", "clean"))):
        check_dependencies()
    ...
    setup(
        ...
        packages=["fmrihandbook", "fmrihandbook.utils"],  # 'fmrihandbook.tests',
